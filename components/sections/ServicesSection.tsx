...
const services = [
  {
    ...
    desc: 'Set up Meta-approved WhatsApp API with chatbots, bulk messaging, team inbox, and CRM integrations. 0% markup on Meta charges.',
    tags: ['Bulk Messaging', 'AI Chatbot', 'Team Inbox'],
